...
Hieruit kwamen volgende resultaten voort. De samengevatte resultaten zijn te zien in tabel \ref{tab:resumed}. Deze resultaten zijn zeer samengevat. De volledige resultatenset per testgeval kan bezichtigd worden in bijlage \ref{appendix:rawresults}, '\nameref{appendix:rawresults}', voor testgeval 1 (tabel \ref{tab:rawresults-1}), testgeval 2 (tabel \ref{tab:rawresults-2}) en testgeval 3 (tabel \ref{tab:rawresults-3}).
...
Figuur \ref{fig:stackedbars-testgeval2} toont per uitvoering van het experiment op testgeval 2, hoeveel keer er een verzoek werd verstuurd naar specifieke domeinen van Google. 
